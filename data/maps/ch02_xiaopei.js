...
MAPS["ch02_xiaopei"] = {
  ...
  chests: [],
    ...
    // 室内下钻（朝门才进，路过不触发）
    { x: 3, y: 5, face: [0, -1], to: { map: "ch02_inn_in", x: 7, y: 8 } },
    { x: 4, y: 5, face: [0, -1], to: { map: "ch02_inn_in", x: 7, y: 8 } },
    { x: 10, y: 5, face: [0, -1], to: { map: "ch02_weapon_in", x: 7, y: 8 } },
    { x: 11, y: 5, face: [0, -1], to: { map: "ch02_weapon_in", x: 7, y: 8 } },
    { x: 13, y: 5, face: [0, -1], to: { map: "ch02_armor_in", x: 7, y: 8 } },
    { x: 14, y: 5, face: [0, -1], to: { map: "ch02_armor_in", x: 7, y: 8 } },
    { x: 3, y: 11, face: [0, -1], to: { map: "ch02_item_in", x: 7, y: 8 } },
    { x: 4, y: 11, face: [0, -1], to: { map: "ch02_item_in", x: 7, y: 8 } },
    { x: 2, y: 16, face: [0, -1], to: { map: "ch02_xiaopei_house_in", x: 7, y: 8 } },
    { x: 3, y: 16, face: [0, -1], to: { map: "ch02_xiaopei_house_in", x: 7, y: 8 } },
  ],
};
